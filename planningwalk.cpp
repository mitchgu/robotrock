...
const float forward_front_dis_threshold = 8;
...
public:
	Planningwalk (Motor* _left,Motor* _right,IR* _irf,IR* _irlf,IR* _irlb,IR* _irr,mraa::Gpio* _irb, Laction* _start) {
